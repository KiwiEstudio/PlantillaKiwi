                    ...
                    <div class="row mb-5">
                        <div class="media tm-flexbox-ie-fix tm-width-ie-fix">
                            <div class="tm-media-img-container">
                                ...
                                <img class="d-flex img-fluid" src="{{asset('assets/img/610x610-01.jpg')}}" alt="Generic placeholder image">
                            </div>
                    ...
                    <div class="row mb-5">
                        <div class="media tm-flexbox-ie-fix tm-width-ie-fix">
                            <div class="tm-media-img-container">
                                ...
                                <img class="d-flex img-fluid" src="{{asset('assets/img/610x610-02.jpg')}}" alt="Generic placeholder image">
                            </div>
                    ...
                    <div class="row mb-5">
                        <div class="media tm-flexbox-ie-fix tm-width-ie-fix">
                            <div class="tm-media-img-container">
                                ...
                                <img class="d-flex img-fluid" src="{{asset('assets/img/610x610-03.jpg')}}" alt="Generic placeholder image">
                            </div>
                    ...
                    <div class="row mb-5">
                        <div class="media tm-flexbox-ie-fix tm-width-ie-fix">
                            <div class="tm-media-img-container">
                                ...
                                <img class="d-flex img-fluid" src="{{asset('assets/img/610x610-04.jpg')}}" alt="Generic placeholder image">
                            </div>
