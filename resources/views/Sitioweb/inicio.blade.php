                ...
                <div class="row mb-4">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 mb-4">
                        <div class="tm-bg-orange p-5">
                            ...
                            <p style="text-align:justify"  >Queremos que tengas las mejores fotografías de tu evento tan importante, por eso nos esforzamos para que conserves esos recuerdos toda la vida, con un toque distinto. nunca está de más tomarse fotos con seres tan importantes en nuestras vidas</p>
                        </div>                            
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 mb-4">
                        <div class="tm-bg-orange p-5">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 mb-4">
                        <div class="tm-bg-orange p-5">
                            ...
                            <h3 class="mb-4">FAMILIAR </h3>
                            <p style="text-align:justify" >Queremos que tengas los mejores recuerdos; por eso nos esforzamos en conseguir las fotografías que deseas, con tu sello personal. Si lo que buscas es algo distinto y creativo estás en el lugar correcto. Podemos hacer para ti y tu familia el mejor recuerdo.</p>
